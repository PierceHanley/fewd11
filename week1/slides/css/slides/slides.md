...
* Great for logos, graphics, other illustrations.
...
* Like `.png` but worse, unless you need animation.
...
* Designed for photos.
* Can make for very small files, but it can make logos and illustrations look blocky.
